<template>
  ...
  >
    <div class="flex items-center">
      <div class="relative">
        ...
        <div
          ...
          class="p-1 mt-[2px] ml-[3px] absolute rounded-full bg-white cursor-pointer"
        >
          <img v-if="!isHoverGif" src="/imgs/sound.gif" />
          <Pause
            v-if="isHoverGif"
            :size="25"
            @click="useSong.playOrPauseSong()"
    ...
    <div class="flex items-center pr-5">
      ...
      >
        <DotsHorizontal
          :fillColor="track.isFavorited ? '#CCCCCC' : 'red'"
          :size="21"
          @click="track.isFavorited = !track.isFavorited"
        />
      </div>
      <div
        v-if="isTrackTime"
        :class="
          track && currentTrack && currentTrack.name === track.name
            ...
            : 'text-[#d4d4d4]'
        "
        class="w-[20px] text-[13px] pl-10 font-[200] text-[#d4d4d4]"
      >
        {{ isTrackTime }}
      </div>
    </div>
